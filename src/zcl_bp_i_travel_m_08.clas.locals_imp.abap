...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE ztravel_M_08.
...
**********************************************************************
  METHOD validate_customer.
    ...
    READ ENTITY ztravel_M_08\\travel FROM VALUE #(
...
********************************************************************************
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF ztravel_M_08 IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF ztravel_M_08 IN LOCAL MODE
         ENTITY travel
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY ztravel_M_08 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD calculatetravelkey.
    ...
    "Get max travelID
    SELECT SINGLE FROM ztravel_app_08 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
